...
<main class="main container">
    <section class="reviews__top_section">
        <div class="reviews__top_section-left">
            ...
            <div class="item">
                <picture>
                    <img src="/upload/images/reviews/main.png" alt="img" loading="lazy">
                </picture>
            </div>
        </div>
    ...
    <section id="reviews__form" class="reviews__form">
        ...
        <div class="reviews__form-send_btn">
            ...
            <!--
            Данный функционал убран в рамках MVP, будет возвращен когда реализуется данный функционал
            ...
            <li class="reviews__item">
                ...
                <div class="reviews__item-right">
                    ...
                    <div class="reviews__item-right--bottom">
                        ...
                        <br>
                        <a href="" class="button">Охранные услуги компании
                            <span class="icon">
                                <svg width="13" height="10" viewBox="0 0 13 10" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
