            ...
            <div class="installment__left-column">
                ...
                <div class="installment__calculator">
                    <div class="section-result__price-bonuses-container">
                        <div class="installment__bonuses-title">Список компонентов заказа, к которому можно применить
                            оплату
                            бонусами
                        </div>
                        ...
                        <div class="section-result__price-item">
                            <div class="section-result__price-item-name">
                                <div class="section-result__price-item-name-name">Датчик такой-то для того Датчик
                                    такой-то
                                    для того
                                </div>
                ...
                <div class="forms">
                    <div class="form" id="form-1">
                        ...
                        <div class="form__bottom">
                            <button class="blue-button"><span>Далее</span></button>
                            <p>Нажимая на кнопку “Далее” вы даете свое согласие<br>
                                <span>с условиями обработки и передачи персональных данных</span></p>
                        </div>
                    </div>

                    <div class="form def-close" id="form-2">
                        <h4>Шаг 2. Регион доставки</h4>
                        <div class="close-btn close-btn_hide">Развернуть</div>
                    ...
                    <div class="form def-close" id="form-3">
                        <h4>Шаг 3. Дополнительная информация</h4>
                        <div class="close-btn close-btn_hide">Развернуть</div>
                        ...
                        <div class="form__content">
                            <form>
                                <div class="form__section">
                                    ...
                                    <div class="form__section__content education">
                                        <div class="select-wrapper">
                                            <select id="select-education" required>
                                                <option value="" disabled selected hidden>Наименование учебного
                                                    заведения
                                                </option>
                                ...
                                <div class="form__section">
                                    ...
                                    <div class="form__section__content family">
                                        <div class="select-wrapper">
                                            <select id="select-family" required>
                                                <option value="" disabled selected hidden>Семейное положение</option>
                                                <option value="1">1</option>
                                                <option value="2">11</option>
                                            </select>
                                        </div>
                                        <div class="select-wrapper">
                                            <select id="select-children" required>
                                                <option value="" disabled selected hidden>Дети до 18 лет</option>
                                                <option value="1">1</option>
                                                <option value="2">11</option>
                                            </select>
                                        </div>
                                ...
                                <div class="form__section">
                                    ...
                                    <div class="form__section__content contact-person">
                                        <input type="text" name="contact-surname"
                                               placeholder="Фамилия контактного лица">
                                        <input type="text" name="contact-name" placeholder="Имя контактного лица">
                                        <input type="text" name="contact-patronomic"
                                               placeholder="Отчество контактного лица">
                                        <input type="text" name="contact-phone" placeholder="Телефон контактного лица">
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="form__bottom">
                            <p>Нажимая на кнопку “Оформить страховой полис” вы даете свое согласие<br>
                                <span>с условиями обработки и передачи персональных данных</span></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="installment__right-column">
                ...
                <div class="installment__rules">
                    ...
                    <p>
                        ...
                        рекламно-информационных рассылок. Согласие предоставляется с момента подписания настоящего
                        полиса и
                    ...
                    <button href="" class="button yellow-button">подать заявку на рассрочку</button>
                </div>
            </div>
        </div>
    </main>
...
<? /*$APPLICATION->IncludeComponent(
    ...
    Array(
        ...
        "PROPS_FADE_LIST_3" => array("20", "21", "22"),
