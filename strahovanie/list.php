...
$APPLICATION->SetTitle("Список страховок");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"OFFERS_FIELD_CODE" => array("ID","NAME","PREVIEW_TEXT","PREVIEW_PICTURE","DETAIL_TEXT","DETAIL_PICTURE","SHOW_COUNTER","SHOW_COUNTER_START","DATE_CREATE",""),
		"OFFERS_LIMIT" => "0",
