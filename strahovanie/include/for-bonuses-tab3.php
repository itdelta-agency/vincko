<div class="tabs__content_slider">
	<div class="item">
		<div class="item__top">
			<div class="item__top_head">
				<div class="item__top_head-left">
					<span class="head">Подписка</span>
					<span class="name">Бесплатная замена оборудования</span>
				</div>
				<div class="item__top_head-right">
                                        <span class="text">
                                            <span class="text_top">1 000</span>
                                            <span class="text_bottom">Бонусов</span>
                                        </span>
					<span class="icon">
			...
			<div class="item__top__content">
				<span class="head">Что такое подписка “Замена оборудования”</span>
				<p>Подписка дает вам возможность бесплатно получить новый датчик для комплекта
					оборудования, купленного на платформе в рамках готового решения.</p>
				<span class="head">Почему эта подписка дает уверенность<br>
                                        при покупке оборудования</span>
				<p>В случае, если один из датчиков в комплекте вышел из строя, с этой подпиской Вы
					просто получите новый взамен, а ваша недвижимость останется под надежной охраной.
				</p>
			</div>
		</div>
