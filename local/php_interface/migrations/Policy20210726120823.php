...
class Policy20210726120823 extends Version
{
  ...
  'IBLOCK_TYPE_ID' => 'equipment',
  'LID' => 
  array (
    0 => 'v1',
  ),
  'CODE' => 'strahovka-offers',
  'API_CODE' => NULL,
  'NAME' => 'Страховка (торговые предложения)',
  'ACTIVE' => 'Y',
  'SORT' => '700',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  ...
  'FILE_TYPE' => '',
  'MULTIPLE_CNT' => '5',
  'LINK_IBLOCK_ID' => 'equipment:strahovka',
  'WITH_DESCRIPTION' => 'N',
  'SEARCHABLE' => 'N',
  'FILTRABLE' => 'N',
  'IS_REQUIRED' => 'N',
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Выплаты по основным пунктам',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PAYMENT_OPTIONS',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'E',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'FILE_TYPE' => '',
  'MULTIPLE_CNT' => '1',
  'LINK_IBLOCK_ID' => 'references:payment-options',
  'WITH_DESCRIPTION' => 'N',
  'SEARCHABLE' => 'N',
  'FILTRABLE' => 'N',
  'IS_REQUIRED' => 'N',
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Стоимость выплаты по основным пунктам, руб.',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'PAYMENT_PRICE',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Подсказка к максимальной выплате',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'MAX_PRICE_TEXT',
  'DEFAULT_VALUE' => 
  ...
  array (
    ...
    'CODE' => 'Символьный код',
    'NAME' => 'Название',
    'PROPERTY_ILL' => 'Иллюстрация',
    'PROPERTY_MAX_PRICE' => 'Максимальная выплата',
    'PROPERTY_MAX_PRICE_TEXT' => 'Подсказка к максимальной выплате',
    'PROPERTY_PAYMENT_OPTIONS' => 'Выплаты по основным пунктам',
    'PROPERTY_PAYMENT_PRICE' => 'Стоимость выплаты по основным пунктам',
    'IBLOCK_ELEMENT_PROP_VALUE' => 'Значения свойств',
    'PROPERTY_CML2_LINK' => 'Элемент каталога',
  ),
  'Анонс|edit5' => 
  array (
