...
$MESS["AUTH_GOT_AUTH"] = "У меня есть учетная запись";
...
$MESS["AUTH_REGISTER_RIGHT_TITLE"] = "Регистрация нового пользователя";
$MESS["AUTH_REGISTER_RIGHT_DESCRIPTION"] = "Регистрация на нашем сайте дает возможность оценивать охранные организации, управлять услугами, надо придумать сюда описание преимуществ регистрации и зачем еще она нужна.";
?>