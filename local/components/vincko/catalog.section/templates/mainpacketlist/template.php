...
<div class="main__packets-list">
		...
		<div class="good__item-data">
			<div class="good__item-info">
				...
				<div class="good__item-complect">
					<?if ($item["PRODUCT_PROPERTIES"]["P_COMPLECT"]["SET"] == 1):?>
					<div class="good__item-complect-item">
						...
						<div class="good__item-complect-item-values">
							<div class="good__item-complect-item-val"><?=$item["PRODUCT_PROPERTIES"]["P_COMPLECT"]["VALUES"][$item["PRODUCT_PROPERTIES"]["P_COMPLECT"]["SELECTED"]]?></div>
						</div>
					</div>
					<?endif;?>
					<?if ($item["PRODUCT_PROPERTIES"]["P_ABONENTPLATA_Y"]["SET"] == 1):?>
					<div class="good__item-complect-item">
						...
						<div class="good__item-complect-item-values">
							<div class="good__item-complect-item-val">Есть</div>
						</div>
					</div>
					<?endif;?>
					<?if ($item["PRODUCT_PROPERTIES"]["P_STRAHOVKA"]["SET"] == 1):?>
					<div class="good__item-complect-item">
						...
						<div class="good__item-complect-item-values">
							...
							<div class="good__item-complect-item-val"><?=$itemS["NAME"]?></div>
							<?endforeach;?>
						</div>
					</div>
					<?endif;?>
			...
			<div class="good__item-price">
				...
				<div class="good__item-discount">
					<?foreach ($item["DISPLAY_PROPERTIES"]["P_BONUSES"]["DISPLAY_VALUE"] as $bonusItem):?>
					<div class="good__item-gift-item"><?=$bonusItem?></div>
					<?endforeach;?>
				</div>
				<?endif;?>
	...
	<div class="chop__list-loadmore">
		<a href="/pakety-okhrannykh-uslug/" class="button__ajax-loader">Показать все</a>
	</div>
	<?endif;?>
</div>
<?
