                        ...
                        <?else:?>
                            <tr>
                                ...
                                <td><?
                                    ...
                                    {
                                        case "PASSWORD":
                                            ?><input size="30" type="hidden" name="REGISTER[<?=$FIELD?>]" value="12345678" autocomplete="off" class="bx-auth-input" />
                                        <?if($arResult["SECURE_AUTH"]):?>
                                            <span class="bx-auth-secure" id="bx_auth_secure" title="<?echo GetMessage("AUTH_SECURE_NOTE")?>" style="display:none">
					<div class="bx-auth-secure-icon"></div>
				</span>
				...
				<span class="bx-auth-secure" title="<?echo GetMessage("AUTH_NONSECURE_NOTE")?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
                                        ...
                                        <?endif?>
                                            ...
                                            break;
                                        case "CONFIRM_PASSWORD":
                                            ?><input size="30" type="hidden" name="REGISTER[<?=$FIELD?>]" value="12345678" autocomplete="off" /><?
                                            break;
                                        ...
                                        default:
                                            ...
                                            <?if ($FIELD == "LOGIN"):?>
                                            <div class="reg__form-block">
                                                <input class="reg__form-input" size="30" type="hidden" name="REGISTER[<?=$FIELD?>]" value="88005553535" />
                                            </div>
                                        <?else:?>
                                            <div class="reg__form-block">
                                                <input class="reg__form-input" size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>"
                                                       placeholder="<?if ($FIELD != "LOGIN" && $FIELD != "PASSWORD" && $FIELD != "CONFIRM_PASSWORD"):?><?=GetMessage("REGISTER_FIELD_".$FIELD)?><?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?>*<?endif?><?endif?>"/>
                                            </div>
                                        <?endif;?>
