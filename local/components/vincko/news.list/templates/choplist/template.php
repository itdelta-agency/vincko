...
<div class="wrap">
	<div class="filter">
		<form action="/ohrannye-predpriyatiya/" method="GET">
...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	<div class="chop__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
		<div class="chop__name-mobile"><?=$arItem["NAME"]?></div>
		<div class="chop__flex">
			...
			<div class="chop__info">
				<div class="chop__title"><a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?echo $arItem["NAME"]?></a></div>
				...
				<div class="chop__cities">Присутствует в <div uk-form-custom="target: > * > span:last-child">
					<select name="price" class="js-chop-select-link">
						<option value=""><?=$arItem["CH_ALL_COUNT"]?> городах</option>
						<?foreach ($arItem["CH_ALL_LIST"] as $arChItem):?>
			...
			<div class="chop__detail">
				...
				<div class="chop__detail-button">
					<a class="chop__detail-link" href="<?=$arItem["DETAIL_PAGE_URL"]?>">Подробнее</a>
				</div>
			</div>
		</div>
	</div>
