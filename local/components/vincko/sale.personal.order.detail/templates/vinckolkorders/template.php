	...
	<div class="lk-columns__right">
			<div class="lk-orders">
				<div class="lk-orders__header">
					<a href="/lk/orders/" class="lk-orders__back inline-block">Все заказы</a>
				</div>
				<div class="lk-orders__list">
					<div class="lk-orders__item">
						<p><?= Loc::getMessage('SPOD_SUB_ORDER_TITLE', array(
					...
					'#DATE_ORDER_CREATE#' => $arResult["DATE_INSERT_FORMATED"]
						...
						<?/*<p>Дата доставки в пункт назначения 26.02.2021</p>*/?>
						<div class="lk-orders__item-userinfo">
							<div class="lk-orders__item-userinfo-row">
								<div class="lk-orders__item-userinfo-title inline-block">Получатель</div>
								<div class="lk-orders__item-userinfo-value inline-block"><?if($userName <> ''){
							...
							<div class="lk-orders__item-userinfo-row">
								<div class="lk-orders__item-userinfo-title inline-block"><?=Loc::getMessage('SPOD_ORDER_DELIVERY')?></div>
								<div class="lk-orders__item-userinfo-value inline-block"><?=htmlspecialcharsbx($shipment["DELIVERY_NAME"])?></div>
							</div>
							<?}?>
							<div class="lk-orders__item-userinfo-row">
								<div class="lk-orders__item-userinfo-title inline-block">Адрес доставки</div>
								<div class="lk-orders__item-userinfo-value inline-block"><?=$arResult["ORDER_PROPS"][3]["VALUE"]?>, <?=$arResult["ORDER_PROPS"][4]["VALUE"]?>, <?=$arResult["ORDER_PROPS"][6]["VALUE"]?></div>
							</div>
							<div class="lk-orders__item-userinfo-row">
							<?foreach ($arResult['PAYMENT'] as $payment){?>
								<div class="lk-orders__item-userinfo-title inline-block">Способ оплаты</div>
								<div class="lk-orders__item-userinfo-value inline-block"><?=$payment['PAY_SYSTEM_NAME']?><?/*<br/>849 р. оплачено бонусами*/?></div>
							<?}?>
							</div>
						</div>
						<div class="lk-orders__item-price">
							<?= Loc::getMessage('SPOD_ORDER_PRICE_BILL')?>: <?=$payment['PRICE_FORMATED']?>
						</div>
						<div class="lk-orders__item-complect-details">
						<?foreach ($arResult['BASKET'] as $basketItem){?>
							<div class="lk-orders__item-complect-details-row">
								<div class="lk-orders__item-complect-details-name">
									<?=$basketItem["NAME"]?>
									<?/*<div class="lk-orders__item-complect-details-link"><a href="#">Подробнее</a></div>*/?>
								</div>
								<?/*<div class="lk-orders__item-complect-details-price-start">50 000 руб.</div>
								<div class="lk-orders__item-complect-details-discount">-2000 скидка</div>*/?>
								<?if ($basketItem["PRICE"] > 0):?><div class="lk-orders__item-complect-details-price-end"><?=$basketItem["PRICE_FORMATED"]?></div><?endif;?>
							</div>
						
							<?/*<div class="lk-orders__item-complect-details-title"><?=htmlspecialcharsbx($basketItem['NAME'])?></div>
							<?if (isset($basketItem['PROPS']) && is_array($basketItem['PROPS'])){?>
							<div class="lk-orders__item-complect-details-sostav">
								<div class="lk-orders__item-complect-details-sostav-title">В составе пакета:</div>
								...
								<div class="lk-orders__item-complect-details-row">
									...
									<div class="lk-orders__item-complect-details-price-start">50 000 руб.</div>
									<div class="lk-orders__item-complect-details-discount">-2000 скидка</div>
									<div class="lk-orders__item-complect-details-price-end">48 000 руб.</div>
								</div>
								<div class="lk-orders__item-complect-details-row">
									<div class="lk-orders__item-complect-details-name">
										Услуги ООО «ЧОП «ЗУБР» г. Краснодар
										<div class="lk-orders__item-complect-details-link"><a href="#">Оставить отзыв</a></div>
									</div>
									<div class="lk-orders__item-complect-details-price-start">50 000 руб.</div>
									<div class="lk-orders__item-complect-details-discount">-2000 скидка</div>
									<div class="lk-orders__item-complect-details-price-end">48 000 руб.</div>
