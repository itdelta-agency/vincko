		...
		<div id="bx-soa-order" class="row bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			...
			<div class="bx-soa order">
				...
				<div id="bx-soa-auth" class="bx-soa-section bx-soa-auth" style="display:none">
					<div class="bx-soa-section-title-container order__subtitle">
						<div class="order__subtitle-left">
							<div class="order__subtitle-point"></div>
							<div class="order__subtitle-name"><?=$arParams['MESS_AUTH_BLOCK_NAME']?></div>
						</div>
					</div>
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					...
					<div id="bx-soa-basket" data-visited="false" class="bx-soa-section bx-active">
						<div class="bx-soa-section-title-container order__subtitle">
							<div class="order__subtitle-left">
								<div class="order__subtitle-point"></div>
								<div class="order__subtitle-name"><?=$arParams['MESS_BASKET_BLOCK_NAME']?></div>
							</div>
				...
				<div id="bx-soa-region" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container order__subtitle">
						<div class="order__subtitle-left">
							<div class="order__subtitle-point"></div>
							<div class="order__subtitle-name"><?=$arParams['MESS_REGION_BLOCK_NAME']?></div>
						</div>
				...
				<? if ($arParams['DELIVERY_TO_PAYSYSTEM'] === 'p2d'): ?>
					...
					<div id="bx-soa-paysystem" data-visited="false" class="bx-soa-section bx-active" <?=($hidePaySystem ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container order__subtitle">
							<div class="order__subtitle-left">
								<div class="order__subtitle-point"></div>
								<div class="order__subtitle-name"><?=$arParams['MESS_PAYMENT_BLOCK_NAME']?></div>
							</div>
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
					...
					<div id="bx-soa-delivery" data-visited="false" class="bx-soa-section bx-active" <?=($hideDelivery ? 'style="display:none"' : '')?>>
						<div class="bx-soa-section-title-container order__subtitle">
							<div class="order__subtitle-left">
								<div class="order__subtitle-point"></div>
								<div class="order__subtitle-name"><?=$arParams['MESS_DELIVERY_BLOCK_NAME']?></div>
							</div>
							<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
						</div>
						<div class="bx-soa-section-content container-fluid"></div>
				...
				<div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-active">
					<div class="bx-soa-section-title-container order__subtitle">
						<div class="order__subtitle-left">
							<div class="order__subtitle-point"></div>
							<div class="order__subtitle-name"><?=$arParams['MESS_BUYER_BLOCK_NAME']?></div>
						</div>
						<div class="col-xs-12 col-sm-3 text-right"><a href="" class="bx-soa-editstep"><?=$arParams['MESS_EDIT']?></a></div>
					</div>
					<div class="bx-soa-section-content container-fluid"></div>
				...
				<div id="bx-soa-orderSave">
					...
					<div class="order__next">
						<a href="javascript:void(0)" style="margin: 10px 0" class="pull-right btn btn-default btn-lg hidden-xs order__next-button inline-block" data-save-button="true">
							<?=$arParams['MESS_ORDER']?>
						</a>
					</div>
				</div>
			...
			<!--	SIDEBAR BLOCK	-->
			<div id="bx-soa-total" class="order__summary">
