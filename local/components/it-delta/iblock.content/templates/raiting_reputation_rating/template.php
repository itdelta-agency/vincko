                            ...
                            <div class="itemRating-open">
                                ...
                                <div class="itemRating-open__top">
                                    ...
                                    while($review = $reviews->GetNext()){
                                        $reviewCount/*[$item["PROPERTIES"]["CITY_ID"]["VALUE"]]*/ += 1;
                                ...
                                <div class="itemRating-open__wrapper">
                                    <div class="itemRating-open__left">
                                        ...
                                        <? endif ?>
                                        <? if($item["PROPERTIES"]["STATUS"]["VALUE"] == "neodobreno"): ?>
                                            <div class="itemRating-open__left_text">
                                                <div class="itemRating-open__left_text-top">
                                                    <span>О компании есть отзывы на платформе, но компания не одобрена</span>
                                                    <a href="#">vincko:</a>
                                                </div>
