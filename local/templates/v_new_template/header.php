    ...
    <div class="header__top container">
        <div class="header__top-left__block">
            ...
            <div class="header__top-logo">
                <a href="/">
                    <picture>
                        <source type="image/webp" srcset="<?=SITE_TEMPLATE_PATH?>/img/header/logo.webp">
                        <source type="image/png" srcset="<?=SITE_TEMPLATE_PATH?>/img/header/logo.png">
                        <img src="<?=SITE_TEMPLATE_PATH?>/img/header/logo.png" alt="logo_img" loading="lazy">
                    </picture>
                </a>
            </div>
                    ...
                    <li class="location" data-modal-target="#header__top-info"><a href="">
                            <span class="icon">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9 1.5C6.0975 1.5 3.75 3.8475 3.75 6.75C3.75 10.6875 9 16.5 9 16.5C9 16.5 14.25 10.6875 14.25 6.75C14.25 3.8475 11.9025 1.5 9 1.5ZM9 8.625C8.50272 8.625 8.02581 8.42746 7.67418 8.07583C7.32254 7.7242 7.125 7.24728 7.125 6.75C7.125 6.25272 7.32254 5.77581 7.67418 5.42418C8.02581 5.07254 8.50272 4.875 9 4.875C9.49728 4.875 9.9742 5.07254 10.3258 5.42418C10.6775 5.77581 10.875 6.25272 10.875 6.75C10.875 7.24728 10.6775 7.7242 10.3258 8.07583C9.9742 8.42746 9.49728 8.625 9 8.625Z"
                                        fill="black" />
                                </svg>
                            </span>
