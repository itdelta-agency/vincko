				...
				<div class="izayavka__form">
					<form method="POST" id="iz-form" action="/ajax/izayavka.php">
						...
						<div class="izayavka__form-block">
							...
							<textarea id="iz-comment" class="js-localstor izayavka__textarea" name="iz_comment" placeholder="Например: необходимо обеспечить охрану и пожарную безопасность коммерческого помещения в г.Суздаль"></textarea>
						</div>
